               ...
               <div className='max-w-2xl sm:py-6 mx-auto'>
                    <div className='bg-white rounded-lg shadow p-6'>
                         ...
                         <form className='space-y-4' onSubmit={e => toast.promise(
                              ...
                              {/* Cover Photo */}
                              <div className='flex flex-col items-start gap-3'>
                                   <label htmlFor='cover-photo' className='block text-sm font-medium text-gray-700 mb-1'>
                                        Cover Photo
                                          ...
                                          <input hidden type="file" accept="image/*" id="cover_photo"
                                             ...
                                             <div className='group/cover relative'>
                                                  ...
                                                  : 
                                                   ...
                                                   left-0 right-0 bottom-0 bg-black/20 rounded-lg items-center justify-center'>
                                                       <Pencil className='w-5 h-5 text-white' />
                                                   </div>
                                             </div>
                                   </label>
